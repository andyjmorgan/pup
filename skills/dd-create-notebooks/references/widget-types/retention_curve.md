...
Use for retention over time by cohort.
...
`product_analytics`, `product_analytics_retention`
...
```bash
pup widgets schema retention_curve --surface notebooks --data-source SOURCE --section request
```
