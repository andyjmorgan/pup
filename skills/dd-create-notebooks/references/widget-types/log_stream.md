...
Use for a direct stream of matching logs.
...
- `log_stream` is deprecated in dashboards; use `list_stream` instead.
...
```bash
pup widgets schema log_stream --surface notebooks --data-source SOURCE --section request
```
